...
- konfigürasyonun tamamlandiğini kontrol edelim:
aws sts get-caller-identity --query Account --output text

1. Security Grouplarin oluşturulmasi:
...
Bu en son AMIyi bulmak için kullanilacak komuttur.
- ilk olarak son ami bilgilerini çekelim
aws ssm get-parameters --names /aws/service/ami-amazon-linux-latest/amzn2-ami-hvm-x86_64-gp2 --region us-east-1

- ikinci aşamada query çaliştirarak son ami numarasini elde edelim 
aws ssm get-parameters --names /aws/service/ami-amazon-linux-latest/amzn2-ami-hvm-x86_64-gp2 --query 'Parameters[0].[Value]' --output text

- sonra bu değeri bir variable a atayalim:
...
- userdata dosyamizi oluşturalim


-şimdi de instance i çaliştiralim:
